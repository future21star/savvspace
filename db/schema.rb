...
ActiveRecord::Schema.define(version: 20170523180112) do
  ...
  add_index "feature_requests", ["feature_id"], name: "index_feature_requests_on_feature_id", using: :btree
  add_index "feature_requests", ["profile_id"], name: "index_feature_requests_on_profile_id", using: :btree
  ...
  add_index "open_house_searches", ["profile_id"], name: "index_open_house_searches_on_profile_id", using: :btree
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.datetime "updated_at",                    null: false
    t.string   "username"
    t.boolean  "idx_enabled",   default: false
  end
  ...
  add_index "service_areas", ["area_id"], name: "index_service_areas_on_area_id", using: :btree
  add_index "service_areas", ["vendor_id"], name: "index_service_areas_on_vendor_id", using: :btree
  ...
  add_foreign_key "open_house_searches", "profiles"
  ...
  add_foreign_key "service_areas", "areas"
  add_foreign_key "service_areas", "vendors"
